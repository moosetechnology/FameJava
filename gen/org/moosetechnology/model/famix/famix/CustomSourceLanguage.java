...
public class CustomSourceLanguage extends SourceLanguage implements TEntityMetaLevelDependency, TNamedEntity, TSourceEntity, TWithComments, TWithSourceLanguage {
        ...
        if (comments == null) {
            comments = new MultivalueSet<TComment>() {
                ...
                protected void setOpposite(TComment e) {
                    e.setContainer(CustomSourceLanguage.this);
                }
            };
        }
        return comments;
