...
public class GlobalVariable extends StructuralEntity implements TAccessible, TDefinedInModule, TEntityMetaLevelDependency, TGlobalVariable, TInvocationsReceiver, TNamedEntity, TSourceEntity, TStructuralEntity, TTypedEntity, TWithComments, TWithSourceLanguage {
        ...
        if (comments == null) {
            comments = new MultivalueSet<TComment>() {
                ...
                protected void setOpposite(TComment e) {
                    e.setContainer(GlobalVariable.this);
                }
            };
        }
        return comments;
        ...
        if (incomingAccesses == null) {
            incomingAccesses = new MultivalueSet<TAccess>() {
                ...
                protected void setOpposite(TAccess e) {
                    e.setVariable(GlobalVariable.this);
                }
            };
        }
        ...
        if (receivingInvocations == null) {
            receivingInvocations = new MultivalueSet<TInvocation>() {
                ...
                protected void setOpposite(TInvocation e) {
                    e.setReceiver(GlobalVariable.this);
                }
            };
        }
