...
public class StructuralEntity extends LeafEntity implements TAccessible, TEntityMetaLevelDependency, TInvocationsReceiver, TNamedEntity, TSourceEntity, TStructuralEntity, TTypedEntity, TWithComments, TWithDereferencedInvocations, TWithSourceLanguage {
        ...
        if (comments == null) {
            comments = new MultivalueSet<TComment>() {
                ...
                protected void setOpposite(TComment e) {
                    e.setContainer(StructuralEntity.this);
                }
            };
        }
        return comments;
        ...
        if (receivingInvocations == null) {
            receivingInvocations = new MultivalueSet<TInvocation>() {
                ...
                protected void setOpposite(TInvocation e) {
                    e.setReceiver(StructuralEntity.this);
                }
            };
        }
