...
public class Type extends ContainerEntity implements TEntityMetaLevelDependency, TNamedEntity, TParameterizedTypeUser, TReferenceable, TSourceEntity, TTraitUser, TType, TWithAttributes, TWithComments, TWithInheritances, TWithMethods, TWithSourceLanguage, TWithTypeAliases {
    ...
    @FameProperty(name = "container", derived = true)
