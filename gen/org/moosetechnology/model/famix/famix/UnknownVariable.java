...
public class UnknownVariable extends StructuralEntity implements TAccessible, TEntityMetaLevelDependency, TInvocationsReceiver, TNamedEntity, TSourceEntity, TStructuralEntity, TTypedEntity, TUnknownVariable, TWithComments, TWithSourceLanguage {
        ...
        if (comments == null) {
            comments = new MultivalueSet<TComment>() {
                ...
                protected void setOpposite(TComment e) {
                    e.setContainer(UnknownVariable.this);
                }
            };
        }
        return comments;
        ...
        if (receivingInvocations == null) {
            receivingInvocations = new MultivalueSet<TInvocation>() {
                ...
                protected void setOpposite(TInvocation e) {
                    e.setReceiver(UnknownVariable.this);
                }
            };
        }
