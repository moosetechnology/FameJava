...
@FameDescription("ImplicitVar")
public class ImplicitVar extends Entity implements TAccessible, TEntityMetaLevelDependency, TImplicitVariable, TNamedEntity, TSourceEntity, TStructuralEntity, TTypedEntity {
        ...
        if (incomingAccesses == null) {
            incomingAccesses = new MultivalueSet<TAccess>() {
                ...
                protected void setOpposite(TAccess e) {
                    e.setVariable(ImplicitVar.this);
                }
            };
        }
