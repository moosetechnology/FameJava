...
import ch.akuhn.fame.internal.PrototypeBuilder;
...
public class Famix22Test {
    ...
    @Test
    public void prototypeBuilder() {
        InputSource input = InputSource.fromResource("ch/unibe/fame/resources/FAMIX22.fm3.mse");
        Parser p = new Parser(new Scanner(input));
        PrototypeBuilder b = new PrototypeBuilder();
        p.accept(b);
        assertTrue(b.getPrototypes().size() > 100);
