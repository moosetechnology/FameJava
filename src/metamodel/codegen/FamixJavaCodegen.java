...
public class FamixJavaCodegen {
    ...
    public static void main(String... args) {
        ...
        CodeGeneration gen = new CodeGeneration(/*destinationPackage*/"org.moosetechnology.model.famixjava", /*outputDirectory*/"gen", /*classNamePrefix*/"");
        gen.accept(famix);
        puts("done");
    }
